...
** Author:      LeoFeng                                                        *
** DATE:        11/13/2008                                                     *
** CopyRight:   2008 EKOOL-TECH CORP. All Rights Reserved.                     *
** Description: Define Implement EK_Cell_LBS service application prototype.    *
********************************************************************************
...
** 11/13/2008       LeoFeng            Create.                                 *
*******************************************************************************/

#ifndef  _MAIN_H_
#define  _MAIN_H_
//#include "mmi_featrues.h"
