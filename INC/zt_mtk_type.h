...
typedef enum
{
	...
	ZT_UART_INTERVAL_SEND_TIMER,
	ZT_DELAY_RESTART_TIMER,
	ZT_BT_UART_HEART_TIMER,
	ZT_BT_DISCONNECT_TIMER,
	ZT_ALARM_PERIOD_TIMER,
	ZT_GIVEBACK_LOCK_TIMER,
	ZT_CHECK_ZUCHE_VALID_TIMER,
	ZT_VOICE_SEARCH_TIMER,
